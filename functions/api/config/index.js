/**
 * config/index.js - Endpoint de configuración para Cloudflare Workers
 * 
 * Este archivo maneja las solicitudes a /api/config/ en el entorno de Cloudflare Workers
 * y proporciona la configuración del cliente de manera segura.
 */
...
export async function onRequest(context) {
  ...
  const clientConfig = {
    ...
    SUPABASE_ORG_ID: 'phzldiaohelbyobhjrnc',
    CLOUDFLARE_ACCOUNT_ID: 'f21b24d86935a055c03d21f7fffd1514',
    KV_NAMESPACE_ID: 'd977cf29acc749ba8aeabbcb2d395cb3',
    D1_DATABASE_ID: 'f00d15a2-6069-4f19-a8eb-6f2217af2176',
    CORS_ORIGIN: '*',

    // Flag para indicar que esta configuración fue cargada correctamente
    CONFIG_LOADED: true,
    CONFIG_VERSION: '2.0.3',
    CONFIG_SOURCE: 'functions-api-config-index',
    CONFIG_TIMESTAMP: new Date().toISOString()
  };
  
  try {
    console.log('Endpoint de configuración /api/config/index.js accedido correctamente');
