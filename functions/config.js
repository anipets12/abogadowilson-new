/**
 * config.js - Endpoint de configuración para Cloudflare Workers
 * 
 * Este archivo maneja las solicitudes a /config y /config.js en el entorno de Cloudflare Workers
...
export async function onRequest(context) {
  ...
  const clientConfig = {
    // Claves de API y configuración con valores predeterminados seguros
    ...
    CONFIG_SOURCE: 'functions-config',
    CONFIG_TIMESTAMP: new Date().toISOString()
  };
  
  try {
    console.log('Endpoint de configuración /config.js accedido correctamente');
